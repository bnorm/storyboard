...
class Decoration(
    ...
    internal fun draw(scope: DrawScope, container: DecoratedElementContainer) {
...
sealed interface DecoratedElementContainer {
...
fun DecorationLayout(
    ...
    val container = remember { DecoratedElementContainerImpl() }
...
private class DecoratedElementContainerImpl : DecoratedElementContainer, DecorationScope {
...
private data class DecoratedElement(
